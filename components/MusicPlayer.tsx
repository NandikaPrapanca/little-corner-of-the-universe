 ...
 *
 * Kuromi has moved to NightSky.tsx where she peeks behind the moon.
 * This component now contains only the player pill.
 */
...
export default function MusicPlayer() {
  ...
  return (
    ...
    >
      ...
      >
        {/* Music icon — toggle expand, rotates while playing */}
        <motion.button
          className="music-btn"
